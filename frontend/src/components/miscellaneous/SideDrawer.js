    ...
    <React.Fragment>
      ...
      >
        <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='white.700' onClick={onOpen} color="white"
            _hover={{ background: "white.800", color:"white.400" }} _active={{ background: "white.800", color:"white.400" }}>
        ...
        <Text fontSize="3xl" fontFamily="Work sans bold" fontWeight='bold' color="white.700" >
          CHATAPP
        </Text>
        ...
        <div>
          ...
          <Menu>
            <MenuButton as={Button} bg="black"  rightIcon={<ChevronDownIcon/>}  
              _hover={{background: "black.800", color:"white.400"}} _active={{background: "black.800", color:"white.400"}}>
              <Avatar size="sm" cursor="pointer" name={user.name} borderColor="black" borderWidth="2px" bg="yellow.400" color="black"/>
            </MenuButton>
            <MenuList bg = "black" borderColor="black" borderWidth="2px">
              <ProfileModal user={user}>
                <MenuItem fontWeight="bold" color="white" _hover={{background: "black"}}  >
                  My Profile
                </MenuItem>{" "}
              </ProfileModal>
              <MenuDivider/>
              <MenuItem fontWeight="bold" color="white" onClick={logoutHandler} _hover={{background: "black"}}>
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
